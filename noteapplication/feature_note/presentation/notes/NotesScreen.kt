...
import com.omaroid.noteapplication.feature_note.presentation.notes.components.NoteItem
import com.omaroid.noteapplication.feature_note.presentation.notes.components.OrderSection
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                IconButton(onClick = {
                    viewModel.onEvent(NotesUiEvent.ToggleOrderSelection)
                }) {
                    Icon(
            ...
            AnimatedVisibility(
                ...
                OrderSection(modifier = Modifier
                    ...
                    onOrderChange = { viewModel.onEvent(NotesUiEvent.Order(it)) })
            }
            ...
            LazyColumn(modifier = Modifier.fillMaxSize()) {
                items(state.notes) { note ->
                    NoteItem(note = note, modifier = Modifier
                        ...
                        viewModel.onEvent(NotesUiEvent.DeleteNote(note))
                        scope.launch {
